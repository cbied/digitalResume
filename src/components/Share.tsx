...
function Share() {
  return (
    <div className="share">
        ...
        <p className='share--text'>I have spent my career as a <span>Javascript</span> developer, developing in <span>React</span> and <span>Angular</span>. I have worked on big enterprise applications at fortune 500 companies, as well as smaller applications, professionally.</p>
